  ...
  */
  ...
  this._generateSheetFrames = function() {
    ...
    for (var i = 0; i < this.sheet_num_frames; i++) {
      this.images.push({'name': i, 'x': sX, 'y': sY, 'width': this.sheet_frame_width, 'height': this.sheet_frame_height});
  ...
  /**
   * Returns true of the argument signature matches a sprite sheet construction
   * @param args
   */
  this.isSheetSignature = function (args) {
    return ((typeof args[0] == 'string' || args[0] instanceof p5.Image) &&
      (args.length === 4 &&
  ...
  // Sprite sheet mode - calculated frames
  else if (this.isSheetSignature(arguments))
  {
    ...
    if (arguments.length === 4) {
      ...
      this.images = _.cloneDeep(arguments[1]);
    }
  }
    ...
    if (this.visible)
    {
      ...
      if(this.images[frame]!==undefined)
      {
        if (this.sheet_image) {
          ...
          image(this.sheet_image, frame_info.x, frame_info.y, frame_info.width,
