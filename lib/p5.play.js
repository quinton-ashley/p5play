...
(function (root, factory) {
	...
	// loaded but just as a precaution I don't want to override their
	// choice
	...
	p5.prototype.registerMethod('init', function p5PlayInit() {
		...
		p5.prototype.AABB = boundp5Class(AABB).call(this);
		p5.prototype.Camera = boundp5Class(Camera).call(this);
		p5.prototype.CircleCollider = boundp5Class(CircleCollider).call(this);
		p5.prototype.Group = boundp5Class(Group).call(this);
		p5.prototype.Sprite = boundp5Class(Sprite).call(this);
		p5.prototype.SpriteAnimation = boundp5Class(SpriteAnimation).call(this);
		p5.prototype.SpriteSheet = boundp5Class(SpriteSheet).call(this);
		 ...
		 * @type {Group}
		 */
		this.allSprites = new Group(this);
	...
	// binds a p5.play class to a p5 instance
	function boundp5Class(TheClass) {
		return function createBoundConstructor() {
			var pInst = this;

			class F extends TheClass {
				constructor(...args) {
					super(pInst, ...args);
				}
			}
...
*/
	...
	class Sprite {
		...
		*/
		...
		AABBops(type, target, callback) {
			...
			} else throw new Error('overlap can only be checked between sprites or groups');
			...
			for (var i = 0; i < others.length; i++)
				if (this !== others[i] && !this.removed) {
					...
					/*
        if(this.colliderType=="default" && this.animation!=null)
        {
          print("busted");
          return false;
        }*/
	...
	class Group extends Array {
		 ...
		 * Keep for backwards compatibility, not necessary now
		 * since Group extends Array.
		 * @method toArray
		 */
		toArray() {
			return this.slice(0);
