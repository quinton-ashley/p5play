...
// If p5 is in global mode, all our p5 instance properties are ultimately
// stored here.
var _globalModeProperties = {};
...
function defineLazyP5Property(name, getter) {
  Object.defineProperty(p5.prototype, name, {
    ...
    get: function() {
      ...
      if (this instanceof p5 && !this._isGlobal) {
        value = getter.call(this);

        // Override our prototype property with an instance property that
        // contains our lazily-created value.
        Object.defineProperty(this, name, {
          enumerable: true,
          value: value
        });
      } else {
        if (!(name in _globalModeProperties)) {
          _globalModeProperties[name] = getter.call(this);
        }
        value = _globalModeProperties[name];
      }
...
p5.prototype.loadAnimation = function() {
  return construct(Animation, this, arguments);
}
...
p5.prototype.loadSpriteSheet = function () {
  return construct(SpriteSheet, this, arguments);
};
  ...
  */
  this.addAnimation = function(label, animation)
  {
    ...
    else
    {
      ...
      anim = construct(Animation, pInst, animFrames);
...
function SpriteSheet(pInst) {
  if (pInst instanceof p5) {
    ...
    // Ack, we were called directly from client code.
    p5.prototype._warn("SpriteSheet() is deprecated; please use " +
...
p5.prototype.SpriteSheet = SpriteSheet;

//general constructor to be able to feed arguments as array
function construct(constructor, pInst, args) {
