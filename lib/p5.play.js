...
p5.prototype.registerMethod('init', function p5PlayInit() {
	...
	class Sprite {
		constructor(x, y, w, h, bodyType) {
			...
			this.position = {
				get x() {
					return (_this.body.getPosition().x / world.tileSize) * plScale;
				},
				set x(val) {
					this.destX = val;
				...
				get y() {
					return (_this.body.getPosition().y / world.tileSize) * plScale;
				},
				set y(val) {
					this.destY = val;
	...
	p5.prototype.drawSprites = function (group) {
		...
		for (let i = 0; i < group.length; i++) {
			...
			const x = width * 0.5 - world.origin.x + pos.x * world.tileSize;
			const y = height * 0.5 - world.origin.y + pos.y * world.tileSize;
	...
	this.isKeyDown = function (keyName) {
		return pInst.keyIsDown(getKeyCode(keyName));
	};
