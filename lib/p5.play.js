...
p5.prototype.registerMethod('init', function p5PlayInit() {
	...
	class Sprite {
		constructor(x, y, w, h, collider) {
			 ...
			 */
			this.shapeColor = group.shapeColor;

			if (this.shapeColor) this.p.color(this.shapeColor);
			else this.shapeColor = this.p.color(this.p.random(255), this.p.random(255), this.p.random(255));
		}
	...
	class Group extends Array {
		constructor(...args) {
			...
			// if the allSprites group exists, and the world doesn't exist,
			// create a new World
	...
	class World extends pl.World {
		constructor(gravityX, gravityY, tileSize) {
			gravityX = round(gravityX || 0);
			gravityY = round(gravityY || 0);
			super(new pl.Vec2(gravityX, gravityY), true);
			this.p = pInst;
