...
function Animation(pInst) {
  ...
  */
   ...
   * @param {Number} x x coordinate
   * @param {Number} y y coordinate
   * @param {Number} [width] optional width to draw
   * @param {Number} [height] optional height to draw
   */
    ...
    if (this.visible)
    {
      ...
      if(this.images[frame] !== undefined)
      {
        if (this.spriteSheet) {
          ...
          var dWidth = width || frame_info.width;
          var dHeight = height || frame_info.height;
          pInst.image(this.spriteSheet.image, this.offX, this.offY, frame_info.width, frame_info.height,
            frame_info.x, frame_info.y, dWidth, dHeight);
        } else {
          var dWidth = width || this.images[frame].width;
          var dHeight = height || this.images[frame].height;
          pInst.image(this.images[frame], this.offX, this.offY, dWidth, dHeight);
        }
      }
      else
      {
