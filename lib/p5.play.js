...
var _globalP5PlayInitializers = [];

function onInitP5Play(initCb) {
  _globalP5PlayInitializers.push(initCb);
}

p5.prototype._initP5Play = function() {
  if (this._p5PlayInitialized) return;

  this._p5PlayInitialized = true;

  _globalP5PlayInitializers.forEach(function(initCb) {
    initCb.call(null, this);
  }, this);
}
...
onInitP5Play(function(pInst) {
  pInst.allSprites = new Group();
  pInst.spriteUpdate = true;
});
...
var cos = p5.prototype.cos;
var sin = p5.prototype.sin;
var dist = p5.prototype.dist;
var atan2 = p5.prototype.atan2;
...
onInitP5Play(function(pInst) {
  pInst.camera = new Camera(pInst, 0, 0, 1);
  pInst.camera.init = false;
});
...
p5.prototype.registerMethod('pre', p5.prototype._initP5Play);
