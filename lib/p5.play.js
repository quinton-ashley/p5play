...
(function (root, factory) {
	...
	function boundp5Class(TheClass) {
		if (typeof TheClass.constructor.name != 'string') {
			throw new TypeError('TheClass must be an ES6 class');
		}
...
*/
	...
	defineLazyP5Property('Sprite', boundp5Class(Sprite));
	...
	defineLazyP5Property('Camera', boundp5Class(Camera));
	...
	defineLazyP5Property('Group', boundp5Class(Group));
	...
	defineLazyP5Property('CircleCollider', boundp5Class(CircleCollider));
	...
	defineLazyP5Property('AABB', boundp5Class(AABB));
	...
	defineLazyP5Property('SpriteAnimation', boundp5Class(SpriteAnimation));
	...
	defineLazyP5Property('SpriteSheet', boundp5Class(SpriteSheet));
