...
p5.prototype.registerMethod('init', function p5PlayInit() {
	...
	class Sprite {
		 ...
		 * using loadAnimation.
		 * Animations require a identifying label (string) to change them. If one is
		 * not provided the name "default" will be used.
	...
	class Group extends Array {
		...
		addImage() {
			if (typeof arguments[0] === 'string' && arguments[1] instanceof p5.Image)
				this.addAnimation(arguments[0], arguments[1]);
			else if (arguments[0] instanceof p5.Image) this.addAnimation('default', arguments[0]);
