...
(function (root, factory) {
	...
	p5.prototype.registerMethod('init', function p5PlayInit() {
		...
		// @param {Number} (width|radius) Width of the placeholder rectangle and of the collider until an image or new collider are set. If height is not set then this parameter becomes the radius of a placeholder circle.
				...
				for (let other of others) {
					...
					if (tunnelTop || tunnelBottom || tunnelLeft || tunnelRight) {
						...
						if (overlapping) {
							...
							// ) {
							console.log('bbox overlap', tunnelTop, tunnelBottom, tunnelLeft, tunnelRight, this, other, bbox, disp);
							// }
						} else {
							console.log('no bbox overlap');
						}
					}
