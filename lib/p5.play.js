  ...
  */
  ...
  this.AABBops = function(type, target, callback) {
    ...
    for(var i=0; i<others.length; i++)
      ...
      {
        var displacement;
        var thisVelocityAlongDisplacement, otherVelocityAlongDisplacement;
        var other = others[i];
        ...
        else if(type === 'collide' || type === 'bounce')
          {
            ...
            if(displacement.x !== 0 || displacement.y !== 0)
            {
              ...
              if(type === 'bounce') {
                ...
                thisVelocityAlongDisplacement = projectAontoB(this.velocity, displacement);
                otherVelocityAlongDisplacement = projectAontoB(other.velocity, displacement);
