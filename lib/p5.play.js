...
(function (root, factory) {
	...
	p5.prototype.registerMethod('init', function p5PlayInit() {
		...
		// @param {Number} (width|size) Width of the placeholder rectangle and of the collider until an image or new collider are set. If height is not set then this parameter is the side length of a square or the radius of a circle if shape type is set to circle.
		// @param {Number} height Height of the placeholder rectangle and of the collider until an image or new collider are set createVector
		class Sprite {
	...
	// quadtree update called after p5.js draw()
	p5.prototype.registerMethod('post', function updateTree() {
