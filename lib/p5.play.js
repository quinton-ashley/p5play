...
(function (root, factory) {
	...
	p5.prototype.registerMethod('init', function p5PlayInit() {
		...
		// @param {Number} (width|radius) Width of the placeholder rectangle and of the collider until an image or new collider are set. If height is not set then this parameter is the radius of a circle, this makes it easy to create circle sprites.
